...
-As a user, I want to log in using my Google account, so that I can access the system quickly. | Là một người dùng, tôi muốn đăng nhập bằng tài khoản Google, để truy cập hệ thống nhanh chóng mà không cần nhớ mật khẩu mới.
